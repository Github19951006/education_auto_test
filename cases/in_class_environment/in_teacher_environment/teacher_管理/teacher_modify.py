...
class Case_tc001051:
	...
	def teststeps(self):
		...
		# 测试步骤如下
		STEP(1, '修改一个老师')
		res_modify_teacher = gs_teacher.modify_teachers(435,'初始化老师',
		                                                str(cid), '13451813456', 'jcysdf@123.com',
		                                                '3209251983090987899',SUBJECT_ID_JUNIOR_MATH)
...
class Case_tc001052:
	...
	def teststeps(self):
		...
		res_modify_teacher = gs_teacher.modify_teachers(teacher_id, '修改初始化老师',
		                                                f'{cid},{self.addClassId}',
		                                                '13451813456', 'jcysdf@123.com','3209251983090987899',None)
		INFO(res_modify_teacher)
...
class Case_tc001053:
	name = '修改老师3（修改真实名和授课班级,' \
	       '授课班级原来是1个班，改为两个班） - tc001053'
	...
	def teststeps(self):
		...
		res_modify_teacher = gs_teacher.modify_teachers(teacher_id, '修改初始化老师',
		                                                 f'{cid},{self.addClassId}',
		                                                '13451813456', 'jcysdf@123.com', '3209251983090987899',SUBJECT_ID_JUNIOR_MATH)
