...
class Case_tc001051:
	...
	def teststeps(self):
		...
		# 测试步骤如下
		STEP(1, '修改一个老师')
		res_modify_teacher = gs_teacher.modify_teachers(435,'初始化老师',1, str(cid), '13451813456', 'jcysdf@123.com',
	                        '3209251983090987899')
...
class Case_tc001052:
	...
	def teardown(self):
		...
		gs_teacher.modify_teachers(teacher_id, '初始化老师',
		                           1, f'{cid}', '13451813456', 'jcysdf@123.com',
		                           '3209251983090987899')
	...
	def teststeps(self):
		...
		cid = GSTORE['id']
		STEP(1, '创建一个班级')
		res_add_class = gs_class.add_class(5, '高二龙山理22班', 66)
		...
		res_modify_teacher = gs_teacher.modify_teachers(teacher_id, '修改初始化老师',
	                        1, f'{cid},{self.addClassId}', '13451813456', 'jcysdf@123.com',
	                        '3209251983090987899')
